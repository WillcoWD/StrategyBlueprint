...
tv.openStrategyTab = async (isDeepTest = false) => {
  ...
  await page.waitForSelector(SEL.strategyCaption)
...
tv.dialogHandler = async () => {
  ...
  if (!document.querySelector(SEL.okBtn) || !document.querySelector(SEL.tabInput))
    return
  if (indicatorTitle === 'test' && action.workerStatus === null) {
...
tv.getEVData = async (data) => {
    
    data['Total EV: All'] = (((data['Winning trades: All'] / data['Total trades: All']) * data['Avg winning trade: All']) - (((data['Total trades: All'] - data['Winning trades: All']) / data['Total trades: All']) * data['Avg losing trade: All'])) * data['Total trades: All']
        
    data['Total EV: Long'] = (((data['Winning trades: Long'] / data['Total trades: Long']) * data['Avg winning trade: Long']) - (((data['Total trades: Long'] - data['Winning trades: Long']) / data['Total trades: Long']) * data['Avg losing trade: Long'])) * data['Total trades: Long']

    data['Total EV: Short'] = (((data['Winning trades: Short'] / data['Total trades: Short']) * data['Avg winning trade: Short']) - (((data['Total trades: Short'] - data['Winning trades: Short']) / data['Total trades: Short']) * data['Avg losing trade: Short'])) * data['Total trades: Short']

    data['Total EV: All'] = data['Total EV: All'] ? data['Total EV: All'].toFixed(2) : 0
    data['Total EV: Long'] = data['Total EV: Long'] ? data['Total EV: Long'].toFixed(2) : 0
    data['Total EV: Short'] = data['Total EV: Short'] ? data['Total EV: Short'].toFixed(2) : 0
