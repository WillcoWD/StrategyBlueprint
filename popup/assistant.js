...
function setOptionsEvents() {
  for(let elId of ['optMinmax', 'optParamName', 'optMethod', 'optFilterOff', 'optFilterMore', 'optFilterLess',
    'optFilterValue', 'optFilterParamName', 'randomDelay', 'shouldTestTF', 'showFullResults','shouldSkipInitBestResult']) {
  ...
  chrome.storage.local.get('iondvOptions', (getResults) => {
    ...
    if (getResults.hasOwnProperty('iondvOptions')) {
      ...
      if(document.getElementById('shouldTestTF') && iondvOptions.hasOwnProperty('shouldTestTF')) {
        ...
        if (document.getElementById('showFullResults') && iondvOptions.hasOwnProperty('showFullResults')) {
        document.getElementById('showFullResults').checked = Boolean(iondvOptions.showFullResults)
      }
...
function getOptions(signal) {
  ...
  iondvOptions.showFullResults = document.getElementById('showFullResults').checked
